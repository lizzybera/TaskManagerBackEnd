...
const processModel_1 = __importDefault(require("../model/processModel"));
const createTask = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { task, priority, isComplete } = req.body;
        const tasked = yield processModel_1.default.create({ task, priority, isComplete });
...
const getTask = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        // console.log("show");
        const tasked = yield processModel_1.default.find().sort({ createdat: -1 });
...
const getOneTask = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { id } = req.params;
        const tasked = yield processModel_1.default.findById(id);
        return res.status(200).json({
...
const updateTask = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { id } = req.params;
        const tasked = yield processModel_1.default.findByIdAndUpdate(id, { isComplete: true }, { new: true });
        return res.status(201).json({
...
const deleteTask = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { id } = req.params;
        const tasked = yield processModel_1.default.findByIdAndDelete(id);
        return res.status(201).json({
